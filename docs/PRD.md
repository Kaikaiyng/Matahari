# IEM / Matahari School Fee & Administration Management System PRD
...
The product is a web-based School Fee & Administration Management System for Matahari International School and, later, other schools under IEM Education Group.

The MVP should be positioned narrowly as a School Fee & Receipt Management System. Its first job is to replace repetitive Excel-based finance administration: monthly invoice preparation, payment tracking, receipt numbering, outstanding fee checking, and collection reporting.
...
| Details | Before/after summary or reason |
