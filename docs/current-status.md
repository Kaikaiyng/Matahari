...
- Final-review regressions passed in the focused backend Community/ability/audit run: 52 tests and 307 assertions. Full backend PHPUnit passed: 389 discovered, 377 passed, 12 existing MariaDB-gated skips, and 2,122 assertions. Pint passed and `route:list --path=api --except-vendor` loaded 151 routes. Admin passed 187/187 Vitest tests; lint exited 0 with 9 existing Calendar Fast Refresh warnings; TypeScript/Vite build passed. App passed 53/53 Vitest tests with clean lint and TypeScript/Vite build.
