...
- Admin typography is unified on the same Plus Jakarta Sans family used by the MAW reference across navigation, pages, forms, tables, buttons, and dialogs. Its Dashboard-led scale now standardises 28px page titles, 20px section/dialog titles, 16px card titles, 14px body and form values, 13px labels/navigation, 12px supporting copy, 11px eyebrows/table headings, and 24–30px key metrics. Ordinary UI emphasis is limited to 400–700 weights so page titles and key numbers retain the visual focus; mobile page/section titles reduce to 24px/18px. JetBrains Mono is limited to technical Application Log values and context payloads, and the separate School App typography is unchanged.
