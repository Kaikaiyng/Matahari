...
export function LoginPage({ onLogin }: { onLogin: (user: CurrentUser) => void }) {
  ...
  return (
    <main className="login-page-container">
      <section className="login-hero-pane" aria-label="MIS Admin Panel">
        <header className="login-brand-header">
          <BrandMark className="login-brand-mark" />
          <div><div className="login-brand-title">{productBrand.organizationName}</div><div className="login-brand-sub">Administration & Finance</div></div>
        </header>

        <div className="login-hero-content">
          <p className="login-hero-kicker">MIS ADMIN PANEL</p>
        ...
        <div className="login-persona-section">
          ...
          <p className="login-app-direction">Parents and students sign in through the separate MIS App.</p>
        </div>
      </section>
      ...
      <section className="login-form-pane">
        <div className="login-form-wrapper">
          ...
          <div className="login-footer-text">Protected by MIS role permissions and audit controls.</div>
        </div>
      </section>
    </main>
  )
