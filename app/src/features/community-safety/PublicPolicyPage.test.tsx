...
describe('public Community policies', () => {
  it('renders escaped policy sections and support contacts', async () => {
    ...
    expect(screen.getByRole('link', { name: /Call Support/i })).toHaveAttribute('href', 'tel:+60 12-345 6789')
    expect(screen.getByRole('link', { name: /WhatsApp Support/i })).toHaveAttribute('href', 'https://wa.me/60123456789')
    expect(screen.getByRole('link', { name: /school-support@matahari.test/i })).toHaveAttribute('href', 'mailto:school-support@matahari.test')
