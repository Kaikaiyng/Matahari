...
type SchoolSupport = { call_phone: string | null; whatsapp_phone: string | null; support_email: string | null; operating_hours: string | null }
type PublicPolicy = { slug: string; title: string; version: string | null; effective_at: string | null; sections: Array<{ heading: string; body: string }>; developer_name: string; organization_name: string; store_safety_disclosure: string; support: { email: string | null; child_safety_email: string | null; school: SchoolSupport | null } }
